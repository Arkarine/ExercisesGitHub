...
public class FirstMissingPositiveFinderNotEffectiveTest {
    private FirstMissingPositiveFinderNotEffective fmp;

    @Before
    public void init(){
        fmp = new FirstMissingPositiveFinderNotEffective();
    }
