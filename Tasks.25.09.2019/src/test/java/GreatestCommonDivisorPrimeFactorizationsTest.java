...
public class GreatestCommonDivisorPrimeFactorizationsTest {

    private GreatestCommonDivisorPrimeFactorizations gcd;

    @Before
    public void init(){
        gcd = new GreatestCommonDivisorPrimeFactorizations();
    }
    ...
    public void findGcd_big(){
        System.out.println(gcd.findGcd(1026, 1881));
    }
}
